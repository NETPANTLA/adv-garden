...
const nodes = [
  ...
  N('viola_jones','Viola–Jones / Haar','vision','Detector clásico en cascada que combina características rectangulares tipo Haar, imagen integral, AdaBoost y rechazo temprano de ventanas negativas.',['rostro','Haar-like','cascada'],[['Viola–Jones CVPR 2001','https://doi.org/10.1109/CVPR.2001.990517']]),
  N('mtcnn','MTCNN','vision','Cascada de tres redes que realiza conjuntamente detección facial y alineación mediante landmarks.',['rostro','cascada','landmarks'],[['MTCNN','https://arxiv.org/abs/1604.02878']]),
...
const DATES = {
  ...
  blazeface:'2019', yunet:'vigente en OpenCV Zoo'
};
...
const level5 = new Set(['advshirt','advhat','rp2','objecthider','translucent','dap','badpatch','yolo_alg','ssd','retinanet','efficientdet','fasterrcnn','maskrcnn','fcos','centernet','detr','deformable_detr','dino_det','rtdetr','groundingdino','yoloworld','yoloe_alg','viola_jones','mtcnn','retinaface_alg','scrfd','blazeface','yunet']);
